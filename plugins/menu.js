...
function toBoldUnicode(str) {
        ...
        const bold = {
                ...
                o:'𝐨', p:'𝐩', q:'𝐪', r:'𝐫', s:'𝐬', t:'𝐭',
                u:'𝐮', v:'𝐯', w:'𝐰', x:'𝐱', y:'𝐲', z:'𝐳',

                A:'𝐀', B:'𝐁', C:'𝐂', D:'𝐃', E:'𝐄', F:'𝐅', G:'𝐆',
                H:'𝐇', I:'𝐈', J:'𝐉', K:'𝐊', L:'𝐋', M:'𝐌', N:'𝐍',
                O:'𝐎', P:'𝐏', Q:'𝐐', R:'𝐑', S:'𝐒', T:'𝐓',
...
const translations = {
        ...
        ar: {
                ...
                tapMenu:
                        '✦ ضغط على 📂 لائحة الاوامر لتحت باش تبدل القسم',
...
${defaultMenu.footer}`
                ...
                const ownerUrl =
                        `https://wa.me/${OWNER_WHATSAPP}?text=${ownerMessage}`
                ...
                await conn.sendButton(
...

                        {
                                ...
                                image: {
                                        ...
                                        url:
                                                'https://cdn.phototourl.com/free/2026-07-26-838589b9-3c52-4c21-99fd-1e7109054e63.png'
                                ...
                                footer:
                                        `${global.namebot} • ${new Date().toLocaleTimeString('ar-MA')}`,
